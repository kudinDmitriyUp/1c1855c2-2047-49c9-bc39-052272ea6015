...
export const metadata: Metadata = {
  title: "Carson Farm - Sustainable Agricultural Products",
  description: "Discover premium crops from Carson Loquaci's certified sustainable farm. Quality produce, modern farming technology, and environmental responsibility.",
  keywords: "agriculture, farm, sustainable crops, organic farming, Carson Loquaci, premium produce",
  metadataBase: new URL("https://carsonloquacifarm.com"),
  alternates: {
    canonical: "https://carsonloquacifarm.com"
  },
  openGraph: {
    title: "Carson Farm - Sustainable Agriculture",
    description: "Premium crops from certified sustainable farm with 20+ years of expertise",
    url: "https://carsonloquacifarm.com",
    siteName: "Carson Farm",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764886942712-x9xzweq1.jpg",
        alt: "Carson Farm landscape"
      }
    ]
  },
  twitter: {
    ...
    title: "Carson Farm - Sustainable Agriculture",
    description: "Premium crops from certified sustainable farm with 20+ years of expertise",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764886942712-x9xzweq1.jpg"]
  },
  robots: {
    index: true,
    follow: true
